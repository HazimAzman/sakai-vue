...
class DownloadController extends ActiveController
{
        ...
        if ($data) {
            ...
            if ($model->save()) {
                ...
                return [
                    'success' => false,
                    'errors' => $model->errors,
                    'message' => 'Failed to create download entry'
                ];
            }
        } else {
            return [
    ...
    public function actionUpdate($id)
    {
        ...
        if (!$model) {
            throw new \yii\web\NotFoundHttpException('Download entry not found');
        }
        ...
        if ($data) {
            ...
            if ($model->save()) {
                ...
                return [
                    'success' => false,
                    'errors' => $model->errors,
                    'message' => 'Failed to update download entry'
                ];
            }
        } else {
            return [
    ...
    public function actionDelete($id)
    {
        ...
        if ($model->delete()) {
            return ['message' => 'Download entry deleted successfully'];
        } else {
            return ['error' => 'Failed to delete download entry'];
        }
    }
}
